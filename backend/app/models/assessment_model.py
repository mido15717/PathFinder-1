...
def create_assessment_document(user_id: ObjectId, payload: dict[str, Any]) -> dict[str, Any]:
    ...
    return {
        ...
        "favorite_subjects": safe_list(payload.get("favorite_subjects")),
        "current_skills": safe_list(payload.get("current_skills")),
        ...
        "personality_traits": safe_list(payload.get("personality_traits")),
